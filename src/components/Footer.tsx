export function Footer() {
  return (
    <footer className="bg-stone-300/50 dark:bg-stone-900/50 border-t border-stone-300 dark:border-stone-700 pb-24">
      <div className="wrapper grid grid-cols-1 md:grid-cols-2 p-4 py-12 gap-4 text-sm text-stone-500 dark:text-stone-400">
        <div className="flex flex-col gap-4">
          ...
          <p className="text-xs leading-relaxed">Minescout · Aquilino de la Guardia St., Banistmo Tower, 10th Floor · Panama City, Panama</p>
          <p>
          ...
          <p className="mt-2">
            <a href="https://builtbybit.com/resources/minelist-minecraft-server-list-script.97340/" target="_blank" rel="nofollow noopener noreferrer" className="text-stone-500 dark:text-stone-400 hover:underline">
              Powered by Minelist, a Minecraft server list script
            </a>
          </p>
        </div>
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-2">
          <div className="footer-link-wrapper">
            <span className="font-minecraft text-lg">References</span>
            <div className="flex flex-col gap-2">
              ...
              <a className="footer-link" href="/pages/how-to-make-a-minecraft-server">How to make a server</a>
              <a className="footer-link" href="/pages/free-minecraft-hosting">Free Minecraft hosting</a>
              <a className="footer-link" href="/pages/how-to-join-a-minecraft-server">How to join a server</a>
              <a className="footer-link" href="/pages/how-to-make-a-modded-minecraft-server">Modded server guide</a>
              <a className="footer-link" href="/how-to-get-more-players-on-a-minecraft-server">How to get more players</a>
